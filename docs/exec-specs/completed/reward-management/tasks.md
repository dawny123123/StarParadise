...
- [x] `star-park/server/src/database.js`
...
- [x] `star-park/server/src/routes/rewards.js`
...
- [x] `star-park/pc-admin/src/views/Rewards.vue`
...
- [x] `star-park/miniprogram/src/api/index.js` — (MODIFY)
- [x] `star-park/miniprogram/src/pages/rewards/index.vue` — (NEW FILE)
- [x] `star-park/miniprogram/src/pages.json` — (MODIFY)
