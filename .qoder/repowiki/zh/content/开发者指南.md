...
章节来源
- [scripts/lint-deps.py:1-248](file://scripts/lint-deps.py#L1-L248)
- [scripts/lint-quality.py:1-124](file://scripts/lint-quality.py#L1-L124)
- [scripts/code-review-check.sh:1-35](file://scripts/code-review-check.sh#L1-L35)
...
SP["pc-admin/package.json"] --> Pcm["pc-admin/src/main.js"]
