...
**更新** 移除了 TodoTree 组件中的'创建人'列显示，简化了任务列表界面。该优化减少了不必要的信息展示，使任务列表更加简洁直观，专注于核心的任务管理功能。

**章节来源**
- [todos.js:5-134](file://star-park/server/src/routes/todos.js#L5-L134)
- [TodoTree.vue:1-435](file://star-park/pc-admin/src/components/TodoTree.vue#L1-435)
...
- 核心数据模型
  ...
  - todos.creator：待办任务的创建人字段，用于记录任务创建者信息。
...
- 数据所有权边界
  ...
  - 待办任务创建人信息通过 creator 字段记录，但不在前端列表中显示。
...
- 业务约束
  ...
  - 待办任务创建人信息存储在数据库中，但前端界面不显示创建人列以简化用户体验。

**更新** 新增待办任务层级关系的业务约束，并明确前端界面简化了创建人信息的展示。
